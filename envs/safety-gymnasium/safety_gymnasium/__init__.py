...
narrow_tasks = {
    'Narrow0': {'floor_conf.type': 'village'},
    'Narrow1': {'floor_conf.type': 'village'},
    'Narrow2': {'floor_conf.type': 'village'},
}
combine(narrow_tasks, robots, max_episode_steps=500)
...
combine(race_tasks, robots, max_episode_steps=500)


human_run_tasks = {'Humanrun0': {}}
combine(human_run_tasks, robots, max_episode_steps=1000)
