...
@dataclass
class Box(Objects):  # pylint: disable=too-many-instance-attributes
    ...
    reward_box_dist: float = 5.0  # Dense reward for moving the agent towards the box
    reward_box_goal: float = 10.0  # Reward for moving the box towards the goal
    ...
    def get_config(self, xy_pos, rot):
        ...
        obj = {
            ...
            'pos': np.r_[xy_pos, self.size + self.z_placement],
            'rot': rot,
